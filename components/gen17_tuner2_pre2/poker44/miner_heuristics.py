...
HAND_MODEL_PATH = BASE_RUNTIME_DIR / "base_runtime" / "hand_model.npz"
CHUNK_AGGREGATOR_MODEL_PATH = BASE_RUNTIME_DIR / "base_runtime" / "chunk_aggregator_model.npz"
RUNTIME_SCORER_PATH = REPO_ROOT / "models" / "score_chunk.py"
RUNTIME_FEATURE_EXTRACTOR_PATH = BASE_RUNTIME_DIR / "base_runtime" / "feature_extractor_frozen.py"
...
def _load_runtime_scorer() -> Any:
    ...
    spec = importlib.util.spec_from_file_location("poker44_gen17_tuner2_pre2_scorer", RUNTIME_SCORER_PATH)
